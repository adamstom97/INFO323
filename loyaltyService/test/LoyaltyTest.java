...
/**
 * A test class for the loyaltyService service.
 *
 * @author adamstom97
 */
public class LoyaltyTest {
	...
	public static void setUpClass() {
		...
		transactions = client.target("http://localhost:8081/customers/"
				  + "06bf537b-c7d7-11e7-ff13-2d957f9ff0f0/transactions/");
		coupons = client.target("http://localhost:8081/customers/"
				  + "06bf537b-c7d7-11e7-ff13-2d957f9ff0f0/coupons/");
		points = client.target("http://localhost:8081/customers/"
				  + "06bf537b-c7d7-11e7-ff13-2d957f9ff0f0/points/");
	}
